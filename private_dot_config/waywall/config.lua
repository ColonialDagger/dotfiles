...
return {
    ...
    -- ==== KEYBINDS ====
    -- resolution changes
    thin = { key = "Right", f3_safe = false, ingame_only = true },
    wide = { key = "Left", f3_safe = true, ingame_only = true },
    ...
    -- ==== MISC ====
    res_1440 = true,
    sens_change = { enabled = true, normal = 5.65646355, tall = 0.38158165 }, -- make sure raw input is off
